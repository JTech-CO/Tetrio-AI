...
TURBO·QUAD(`3-q`)만으로 돌린 1,500피스 장기 실행(2026-09-25, 1278×1002, [로그](docs/quad-turbo-run-1500-2026-09-25.txt))도 오배치 없이 완주했습니다.

| 항목 | 결과 |
|---|---|
| 전체 | 1,500피스 / 282초 = 5.31 피스/초 (연결·시작 메뉴 대기·레벨 전환 포함) |
| TURBO 실효 속도 | 중앙값 6.98 PPS, 최고 7.60 PPS |
| 라인 | 599줄 중 560줄(93.5%)이 쿼드 140회 |
| 오배치 / 의심 피스 | 0 / 0 |
| RAPID 전환 | 3회 — 레벨 전환 2회(스택 5줄에서 복귀), 스택 12줄 1회(6줄에서 복귀) |
| 리싱크 | 2회(레벨 전환 때) |
